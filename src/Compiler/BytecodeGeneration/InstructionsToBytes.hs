...
instructionToByte Aconst_Null = 0x01 : []
...
instructionToByte (Bipush byte) = 0x10 : convertInt8ToWort8 byte : []
instructionToByte (Sipush value) = 0x11: convertInt16ToListWord8 value
...
instructionToByte (Goto branch) = 0xa7 : convertWord16ToListWord8 branch
...
instructionToByte (If_Icmpge branch) = 0xa2 : convertWord16ToListWord8 branch
instructionToByte (If_Icmpgt branch) = 0xa3 : convertWord16ToListWord8 branch
instructionToByte (If_Icmple branch) = 0xa4 : convertWord16ToListWord8 branch
instructionToByte (If_Icmplt branch) = 0xa1 : convertWord16ToListWord8 branch
instructionToByte (If_Icmpne branch) = 0xa0 : convertWord16ToListWord8 branch
instructionToByte (Ifeq branch) = 0x99 : convertWord16ToListWord8 branch
instructionToByte (Ifge branch) = 0x9c : convertWord16ToListWord8 branch
instructionToByte (Ifgt branch) = 0x9d : convertWord16ToListWord8 branch
instructionToByte (Ifle branch) = 0x9e : convertWord16ToListWord8 branch
instructionToByte (Iflt branch) = 0x9b : convertWord16ToListWord8 branch
instructionToByte (Ifne branch) = 0x9a : convertWord16ToListWord8 branch
instructionToByte (Ifnonnull branch) = 0xc7 : convertInt16ToListWord8 branch
instructionToByte (Ifnull branch) = 0xc6 : convertInt16ToListWord8 branch
instructionToByte (Iinc index count) = 0x84 : index : fromIntegral count : [] 
...
instructionToByte (Lookupswitch _ _ _ _ _ _ _ _ _) = 0xab : [] -- TODO: Empty, dummy
...
instructionToByte (Tableswitch _ _ _ _ _ _ _ _ _ _ _ _ _) = 0xaa : [] -- TODO: Empty, dummy
